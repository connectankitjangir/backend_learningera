...
from .models import answer_key_generator,form_video,exam_details,result_video,original_candidates_data,raw_marks_candidates_data,normalized_marks_candidates_data,ssc_cgl_2024_answerkey
...
class ssc_cgl_2024_answerkeyAdmin(admin.ModelAdmin):
    list_display = ('link','id')
admin.site.register(ssc_cgl_2024_answerkey, ssc_cgl_2024_answerkeyAdmin)
